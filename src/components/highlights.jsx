...
<div className="card-group">
  <div className="card">
    <img src="src\assets\skates-3623008_1280.jpg" class="card-img-top" alt="skates" style={{ height: '250px', width: '400px', objectFit: "cover" }}/>
  ...
  <div className="card">
    <img src="src\assets\question-mark-3585355_1280.jpg" class="card-img-top" alt="question" style={{ height: '250px', width: '400px', objectFit: "cover" }}/>
    <div className="card-body">
  ...
  <div className="card">
    <img src="src\assets\apple-1282241_1280.jpg" class="card-img-top" alt="apple" style={{ height: '250px', width: '400px', objectFit: "cover" }}/>
    <div className="card-body">
